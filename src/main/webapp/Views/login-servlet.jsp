...
<body>
<form method="post">
    <div class="d1"><span><h1>LogIn page!</h1></span></div>
    <div class="text-field">
    <label class="text-field-label">Login:
        <input type="text" name="name" class="text-field-input">
    </label>
    ...
    <button class="glow-button">login</button>
    <br/>
    <div class="d2"> <h3>User valid status: <%=request.getAttribute("isPassValid")%></h3></div>
</form>
</body>
<style>
    body {
